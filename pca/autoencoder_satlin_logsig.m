...
for hiddenSize = [10, 20, 30, 40, 50]
  for maxEpochs = [50, 100, 150, 200, 250]
    ...
    fprintf('Hidden Layer Size: %d, Number of Epochs: %d, Reconstruction Error: %.2f, EncoderFunction: satlin, DecoderFunction: logsig\n', hiddenSize, maxEpochs, reconstructionError);
    ...
    subtitle('EncoderFunction: satlin, DecoderFunction: logsig')
